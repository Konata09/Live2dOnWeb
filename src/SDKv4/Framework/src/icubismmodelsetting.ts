...
export namespace Live2DCubismFramework {
    ...
    export abstract class ICubismModelSetting {
        ...
        /**
         * Get motion file name from group name and index value
         * @param groupName Name of motion group
        ...
        /**
         * Get the name of the sound file corresponding to the motion
         * @param groupName  Name of motion group
         * @param index Array index value
         ...
         * @param index   动作索引
         */
        public abstract getMotionSoundDelay(groupName: string, index: number): number;
