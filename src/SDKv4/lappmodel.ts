...
export class LAppModel extends CubismUserModel {
   ...
   */
  public playMotionSound(soundFileName: string): void {
    if (/(\.mp3|\.aac|\.m4a|\.opus|\.ogg|\.caf|\.wav|\.webm|\.flac|\.mp4)$/i.test(soundFileName)) {
      ...
      audioMotion
        .play()
        .then(() => this._debugMode && console.log(`[Live2Dv4] play sound: ${soundFileName}`))
          .catch(e=>this._debugMode && console.error(`[Live2Dv4] FAIL play sound: ${soundFileName} ${e}`))
    }
  }
  /**
